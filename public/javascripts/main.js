...
if(!a4||typeof a4!="string"){z(g[b3],null)
return}finishClass(a4)
var a5=g[a4]
if(!a5)a5=existingIsolateProperties[a4]
var a6=g[b3]
var a7=z(a6,a5)
if(Object.prototype.hasOwnProperty.call(a7,"%")){var a8=a7["%"].split(";")
if(a8[0]){var a9=a8[0].split("|")
for(var b0=0;b0<a9.length;b0++){init.interceptorsByTag[a9[b0]]=a6
init.leafTags[a9[b0]]=true}}if(a8[1]){a9=a8[1].split("|")
if(a8[2]){var b1=a8[2].split("|")
for(var b0=0;b0<b1.length;b0++){var b2=g[b1[b0]]
b2.$nativeSuperclassTag=a9[0]}}for(b0=0;b0<a9.length;b0++){init.interceptorsByTag[a9[b0]]=a6
init.leafTags[a9[b0]]=false}}}}var a2=Object.keys(a3.pending)
...
else if(z.m(c,2))return new H.Q(a,d,e).$0()
else if(z.m(c,3))return new H.R(a,d,e,f).$0()
else if(z.m(c,4))return new H.dr(a,d,e,f,g).$0()
...
"^":"",
Iq:function(){document.querySelector("#dart").textContent="Hello from dart:html"
H.U("You use dart")}},1],]
